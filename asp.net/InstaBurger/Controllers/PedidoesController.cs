...
namespace InstaBurger.Controllers
{
    public class PedidoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PedidoId,Nome,Morada,CodigoPostal,Localidade,Telefone,Email,PedidoEnviado,PedidoEntregueEm")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PedidoId,Nome,Morada,CodigoPostal,Localidade,Telefone,Email,PedidoEnviado,PedidoEntregueEm")] Pedido pedido)
        {
