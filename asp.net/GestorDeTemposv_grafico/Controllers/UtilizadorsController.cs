...
namespace GestorDeTempos.Controllers
{
    ...
    public class UtilizadorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UtilizadorName,Senha")] Utilizador utilizador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UtilizadorName,Senha")] Utilizador utilizador)
        {
            if (id != utilizador.Id)
            {
                return NotFound();
